...
<html>
	<head>
        ...
        <script type="text/javascript" src="js/registaration.js">
        </script>
        <link rel="stylesheet" href="css/registaration.css">
            ...
            <h1 class="well" style="position:center ;color:blue" >Registration Form</h1>
                <div class="col-lg-12 well">
                    <div class="row">
                        ...
                        <form method="post" action="profile.php" id="myForm" name="studentDetails" onsubmit="validate(event)">
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 form-group">
                                        <h4>Alt. E-mail:
                                        <input class="form-control" type="email" name="altEmail" id="altEmail"  placeholder="eg:abc@xyz.com" ><br>
                        ...
                        <?php else: ?>
                            <button type="submit" class="btn" style="margin-left:40%; width: 20%;" name="submit"  value="submit">submit</button>
                        <?php endif ?> 
                        </form>
