          ...
          <div class="col-lg-4 col-md-6 filter-app">
            <div class="portfolio-item">
              ...
              <div class="portfolio-info">
                <h3><a href="assets/img/img4.jpg" data-gall="portfolioGallery" class="venobox" title="App 1">App 1</a></h3>
                <a href="assets/img/img4.jpg" data-gall="portfolioGallery" class="venobox" title="App 1"><i class="icofont-plus"></i></a>
              </div>
            </div>
          </div>
